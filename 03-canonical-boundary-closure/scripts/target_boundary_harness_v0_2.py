#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""TARGET-BOUNDARY prospective harness v0.2."""
...
FIX=HERE/"TARGET_BOUNDARY_FIXTURES_v0_2.json"
ORA=HERE/"TARGET_BOUNDARY_ORACLES_v0_2_PRIVATE.json"
...
def main(argv=None):
    ...
    print("TARGET-BOUNDARY VERDICT:",
          "TB-PROSPECTIVE FINITE NON-REFUTATION" if passes==total
          else "TB-CANDIDATE REFUTED")
